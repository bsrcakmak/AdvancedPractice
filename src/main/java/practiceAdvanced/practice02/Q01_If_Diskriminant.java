...
public class Q01_If_Diskriminant {
   ...
   */
    public static void main(String[] args) {
        ...
        double delta= b*b-4*a*c;  // veya b^2-4*a*c;

        if (delta>0){

            double x1= (-b + Math.sqrt(delta))/(2*a);
            double x2= (-b - Math.sqrt(delta))/(2*a); // Math class indaki karekok alma methodu
            ...
            System.out.println("Denklemin herhangi bir koku yoktur");
        }
